...
neumaticos_a_poner = permutations(numeros_neumaticos, numero_paradas)
...
for i in lista_paradas: # Para cada combinacion de vueltas de parada
    for j in neumaticos_a_poner: # Para cada permutacion de neumaticos a poner
        ...
        vueltas_desde_la_parada = 1 # Vueltas desde la ultima parada
        numero_parada = 0 # Paradas realizadas
        ruedas = 2
