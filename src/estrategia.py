...
def estrategia(vueltas:int, tiempo1,tiempo2,tiempo3,desgaste1,desgaste2,desgaste3):
    # El tiempo por vuelta sin desgaste de neumáticos es 100 segundos por vuelta
    lista_tiempos_base = [tiempo1, tiempo2, tiempo3]
    # tiempo_base1 = 100
    # tiempo_base2 = 101
    # tiempo_base3 = 102
    ...
    lista_extras = [desgaste1,desgaste2,desgaste3]
    # extra_1 = 0.9
    # extra_2 = 0.6
    # extra_3 = 0.3
...
def carrera1():
    respuesta = input("Simulacion previa o durante carrera: simulacion/carrera")
    if respuesta == "simulacion":
        vueltas = int(input("Numero de vueltas: "))
        tiempo_blando = float(input("Tiempo medio del blando: "))
        tiempo_medio = float(input("Tiempo medio del medio: "))
        tiempo_duro = float(input("Tiempo medio del duro: "))
        desgaste_blando = float(input("Desgaste del blando: "))
        desgaste_medio = float(input("Desgaste del medio: "))
        desgaste_duro = float(input("Desgaste del duro: "))
        estrategia(vueltas, tiempo_blando, tiempo_medio, tiempo_duro, desgaste_blando, desgaste_medio, desgaste_duro)
